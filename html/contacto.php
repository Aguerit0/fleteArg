...
[  ]*/
    ...
    /* Estilos para el input tipo textarea-like */
.textarea-like {
  /* Cambiar el tamaño vertical del input */
  height: 150px;
  /* Ajustar el espaciado y el borde para que se parezca a un textarea */
  padding: 10px;
  border: 1px solid #ccc;
  /* Permitir que el contenido se desplace verticalmente */
  overflow-y: auto;
  /* Asegurarse de que el texto se ajuste adecuadamente */
  box-sizing: border-box;
}
...
<body>
    ...
    <!-- Header -->
    <header id="header">
        <h1 id="logo"><a href="index.php">FleteAr</a></h1>
        <nav id="nav">
            <ul>
            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form" id="form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Name is required">
                        <input class="input100" type="text" name="from_name" placeholder="Ingresa tu nombre..." style="color: white;" id="from_name">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" type="text" name="email_id" placeholder="Ingresa tu correo..." id="email_id">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                    ...
                    <textarea name="message" id="message" class="input100 textarea-like"></textarea>
  <span class="focus-input100"></span>
</div>

                    <div class="container-contact100-form-btn">
                        <input style="background-color: #645CAA;" type="submit" class="contact100-form-btn" value="enviar" name="button" id="button">
    ...
    <script>
        ...
        document.getElementById('form')
            .addEventListener('submit', function(event) {
                ...
                const templateID = 'template_28uwjxd';
